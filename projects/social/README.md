...
500 - 100 users with avg of 10 friend each equals 1000 friendship.  Each time you call `add_friendship()`, two friendships are created.  One between the friend and user, and one between the user and friend.
